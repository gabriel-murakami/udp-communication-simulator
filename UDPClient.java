    ...
    while(running){
      ...
      case 4:
        ...
        for(int i=0; i<WINDOW_SIZE; i++) {
          ...
          if(i==1 && !duplicate) {
            System.out.println("Mensagem '" + packet.getMsg() + "' enviada de forma DUPLICADA com ID " + i);
          }
          else {
            System.out.println("Mensagem '" + packet.getMsg() + "' enviada com ID " + i);
          }
      ...
      case 5:
        ...
        for(int i=0; i<WINDOW_SIZE; i++) {
          ...
          if(slowPacketId == i){
            System.out.println("Mensagem '" + packet.getMsg() + "' enviada de forma LENTA com ID " + i);
          }
          else{
            System.out.println("Mensagem '" + packet.getMsg() + "' enviada com ID " + i);
          }
